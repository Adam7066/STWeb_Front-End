  ...
  <t-head-menu theme="light" class="drop-shadow" :value="headMenuVal">
    ...
    <template #operations>
      <div class="mr-8 flex items-center justify-center">
        ...
        <client-only v-if="userStore.isLoggedIn">
          ...
          <t-popup :destroy-on-close="true" trigger="click">
            ...
            <template #content>
              <t-menu :value="headMenuVal">
                ...
                <t-divider v-if="userStore.isLoggedIn" class="!my-2" />
...
const menu = [
  ...
  [ // Right
    { value: 'login', to: '/login', content: '登入', icon: 'login', visible: !userStore.isLoggedIn },
  ],
  [ // Avatar Group 0
    { value: 'dashboard', to: '/dashboard', content: '儀表板', icon: 'dashboard-1', visible: userStore.isLoggedIn },
    { value: 'setting', to: '/setting', content: '設定', icon: 'setting-1', visible: userStore.isLoggedIn },
  ],
  [ // Avatar Group 1
    { value: 'logout', to: '/logout', content: '登出', icon: 'logout', visible: userStore.isLoggedIn },
  ],
]
